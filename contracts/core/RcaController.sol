...
contract RcaController is RcaGovernable {
    ...
    function verifyCapacitySig(
        ...
        // console.log("[verifyCapacitySig 0]", address(this), _user);
        // console.log("[verifyCapacitySig 1]", msg.sender, _amount);
        // console.log("[verifyCapacitySig 2]", nonces[_user], _expiry);
        ...
        console.log("[signatory]", signatory, capOracle);
    ...
    function getMessageHash(
        ...
        // console.log("[getMessageHash 0]", address(this), _user);
        // console.log("[getMessageHash 1]", _shield, _amount);
        // console.log("[getMessageHash 2]", _nonce, _expiry);
        return
            keccak256(
                abi.encodePacked(
                    "EASE_RCA_CONTROLLER_1.0",
